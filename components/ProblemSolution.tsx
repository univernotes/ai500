          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-8 rounded-2xl shadow-md border border-agro-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 text-sm">
                Наша система использует альтернативные данные для интеллектуальной оценки кредитоспособности (AgroScore AI), позволяя выдавать быстрый предварительный скоринг без необходимости предоставления полного пакета бумажных документов
              </p>
            </div>
